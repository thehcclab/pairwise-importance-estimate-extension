...
def main():
    ...
    model= Models.Univariate_IELayer(device=device, input_dim=data.X.shape[1],
...
if __name__=="__main__":
    ...
    model= main()
    post(default_path, config, feat, model, data.y, classes, val_dataloader, "Weight")
