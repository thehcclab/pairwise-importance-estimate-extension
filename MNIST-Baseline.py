...
def main():
    ...
    model= MNISTBaseline_Model(device=device, input_dim=dataset_val.X.shape[1], classes=classes).to(device)
...
if __name__=="__main__":
    ...
    model= main()
    post(default_path, config, feat, model, dataset_val.y, classes, val_dataloader, "Baseline")
