...
def main():
    ...
    baseline_model= DryBeanBaseline_Model(device=device, input_dim=input_dim, classes=classes)
    ...
    pickle.dump( model.return_pairwise_weights(), open(f"{dir_path}{feat}-w-{config['epoch']}.pkl", "wb") )
